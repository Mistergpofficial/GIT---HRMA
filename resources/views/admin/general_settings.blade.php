                            ...
                            <div class="col-sm-12 portlet">
                                <section class="panel panel-success portlet-item">
                                    ...
                                    <section class="panel panel-default">
                                        ...
                                        <a href="{{  route('admin.update-general_settings') }}" class="btn btn-success" style="float:right;">Update General Settings</a>
                                        <br>
                                                    ...
                                                    <div class="panel-body">
                                                        <form action="{{ route('admin.general_settings') }}" method="post" enctype="multipart/form-data">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" value="{{ old('company_name') }}" class="form-control"  name="company_name" >
