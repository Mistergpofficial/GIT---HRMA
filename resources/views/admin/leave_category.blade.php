                                                            ...
                                                            <div class="col-md-8 col-md-offset-2">
                                                                <div class="panel panel-default">
                                                                    ...
                                                                    <div class="panel-body">
                                                                        ...
                                                                        <form class="form-horizontal" role="form" method="POST" action="{{ route('admin.leave_category') }}">
                                                                            {{ csrf_field() }}
                                                                            ...
                                                                            <div class="form-group{{ $errors->has('leave_category') ? ' has-error' : '' }}">
                                                                                ...
                                                                                <div class="col-md-6">
                                                                                    <input id="leave_category" type="text" class="form-control" placeholder="Enter Your leave Category Name" name="leave_category" value="{{ old('leave_category') }}" required>
